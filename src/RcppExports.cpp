...
// eadam_cpp
List eadam_cpp(IntegerMatrix s_prefs, IntegerMatrix c_prefs, IntegerVector n_slots, String acceptance, LogicalVector consent, int bound_ea_iters);
RcppExport SEXP _matchingMarkets_eadam_cpp(SEXP s_prefsSEXP, SEXP c_prefsSEXP, SEXP n_slotsSEXP, SEXP acceptanceSEXP, SEXP consentSEXP, SEXP bound_ea_itersSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type bound_ea_iters(bound_ea_itersSEXP);
    rcpp_result_gen = Rcpp::wrap(eadam_cpp(s_prefs, c_prefs, n_slots, acceptance, consent, bound_ea_iters));
