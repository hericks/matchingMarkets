...
eadam_cpp <- function(s_prefs, c_prefs, n_slots, acceptance, consent, bound_ea_iters) {
    .Call(`_matchingMarkets_eadam_cpp`, s_prefs, c_prefs, n_slots, acceptance, consent, bound_ea_iters)
}
